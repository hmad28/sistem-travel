...
export default async function LoginPage() {
  ...
  return (
    <main className="grid min-h-screen bg-[#f3f5f3] lg:grid-cols-[1.05fr_.95fr]">
      <section className="relative hidden min-h-screen overflow-hidden bg-[#142b59] text-white lg:block">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(20,43,89,.28),rgba(20,43,89,.92))]" />
        ...
        <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#142b59] px-7 py-12 text-white sm:px-12">
